...
const weather = [{
    ...
    Name: 'Cloudy',
    SolarOut: BigInt(getRandom(25, 75)),
    WindOut: BigInt(getRandom(25, 75))
}, {
    Name: 'Cloudy',
    SolarOut: BigInt(getRandom(25, 75)),
    WindOut: BigInt(getRandom(25, 75))
    ...
    Name: 'Rain',
    SolarOut: BigInt(getRandom(0, 50)),
    WindOut: BigInt(getRandom(50, 100))
}, {
    Name: 'Rain',
    SolarOut: BigInt(getRandom(0, 50)),
    WindOut: BigInt(getRandom(50, 100))
    ...
    Name: 'Stormy',
    SolarOut: BigInt(getRandom(0, 100)),
    WindOut: 100n
}, {
    Name: 'Thundstorm',
    SolarOut: 0n,
